...
<?php else: ?>
    <section class="hero-panel p-0 mb-5">
        <div class="row g-0 align-items-stretch">
            <div class="col-lg-4">
                <img src="<?= esc($book['cover_image'] ?: base_url('img/cover.png')); ?>" onerror="this.onerror=null;this.src='<?= base_url('img/cover.png'); ?>';" alt="Capa do livro <?= esc($book['title']); ?>" class="book-cover">
            </div>
