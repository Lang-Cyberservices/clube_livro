...
return [
    ...
    'max_length'            => 'O campo {field} não pode exeder {param} caracteres.',
    ...
    'valid_date'            => 'O campo {field} tem ser em formato de data.',
    ...
    //tarefas
    'tempoMinimoTarefa' => 'A data final precisa ser maior que a menor',
    "horarioEncavalado" => 'Esse intervalo de horarío condiz com uma tarefa desse mesmo projeto',
];