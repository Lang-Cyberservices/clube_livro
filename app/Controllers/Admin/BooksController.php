...
class BooksController extends BaseController
{
    ...
    {
        $data = $this->getValidatedBookData(null);
    ...
    public function update(int $id)
    {
        ...
        $data = $this->getValidatedBookData($book);
    ...
    private function getValidatedBookData(?array $existingBook = null): ?array
    {
        $rules = [
        ...
        try {
            $coverImage = $this->resolveUploadedCover($existingBook['cover_image'] ?? null);
        } catch (\RuntimeException $e) {
            $this->validator->setError('cover_image_file', $e->getMessage());
            return null;
        }
